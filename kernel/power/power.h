...
ssize_t modem_reset_store(struct kobject *kobj, struct kobj_attribute *attr,
                    const char *buf, size_t n);
ssize_t modem_status_show(struct kobject *kobj, struct kobj_attribute *attr, 
                    char *buf);
ssize_t modem_status_store(struct kobject *kobj, struct kobj_attribute *attr,
                    const char *buf, size_t n);
ssize_t modem_set_show(struct kobject *kobj, struct kobj_attribute *attr, 
                    char *buf);
ssize_t modem_set_store(struct kobject *kobj, struct kobj_attribute *attr,
                    const char *buf, size_t n);
