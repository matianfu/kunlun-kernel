...
struct twl4030_platform_data {
	...
	/*VMMC2 for V_KBD_BL*/
	struct regulator_init_data		*kbl;
	/*GPIO Switch in Kunlun*/
	struct regulator_init_data		*gps;
	struct regulator_init_data		*cam;
	struct regulator_init_data		*wlan;
	struct regulator_init_data		*bt;
	struct regulator_init_data		*fm;
#endif
};
...
#define SWITCH_GPIO_CAM		(TWL4030_REG_VUSB3V1 + 3)
#define SWITCH_GPIO_WLAN	(TWL4030_REG_VUSB3V1 + 4)
...
#define BT_SW_GPIO	(109)
#define FM_SW_GPIO	(161)
#endif
