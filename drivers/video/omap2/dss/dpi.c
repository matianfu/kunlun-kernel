...
void omapdss_dpi_display_disable(struct omap_dss_device *dssdev)
{
	...
	/*
	 * Sometimes FRAME DONE irq doens't come, and DISPC won't clear GO bit.
	 * Don't know why. But this cause system hang when power off system.
	 *
	 * Workaround:
	 * 1Mhz = 1us. Pixel clock is 10Mhz. So I think 1ms is enough.
