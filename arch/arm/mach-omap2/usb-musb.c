...
#ifdef CONFIG_USB_ANDROID_KUNLUN_FEATURES
#define VIATELECOM_VENDOR_ID                        0x15EB
#define VIATELECOM_CBP_PRODUCT_ID                   0x0001
#define VIATELECOM_KUNLUN_PRODUCT_ID                0x1001
#define VIATELECOM_KUNLUN_ADB_PRODUCT_ID            0x1002
#define VIATELECOM_KUNLUN_CDROM_PRODUCT_ID          0x1003
#define VIATELECOM_KUNLUN_TENTHERING_PRODUCT_ID     0x1004
#define VIATELECOM_KUNLUN_TENTHERING_ADB_PRODUCT_ID 0x1005
#endif

static char device_serial[MAX_USB_SERIAL_NUM];

static char __maybe_unused *usb_functions_ums[] = {
	"usb_mass_storage",
};

static char __maybe_unused *usb_functions_adb[] = {
	"adb",
};

static char __maybe_unused *usb_functions_ums_adb[] = {
	"usb_mass_storage",
	"adb",
};

static char __maybe_unused *usb_functions_rndis[] = {
	"rndis",
};

static char __maybe_unused *usb_functions_rndis_adb[] = {
	"rndis",
	"adb",
};

static char __maybe_unused *usb_functions_acm[] = {
	"acm",
};

static char __maybe_unused *usb_functions_acm_adb[] = {
	"acm",
	"adb",
};

static char __maybe_unused *usb_functions_acm_ums_adb[] = {
	"acm",
	"usb_mass_storage",
	"adb",
};

static char __maybe_unused *usb_functions_mtp[] = {
	"mtp",
};

static char __maybe_unused *usb_functions_mtp_adb[] = {
	"mtp",
	"adb",
};
static char __maybe_unused *usb_functions_mtp_ums_adb[] = {
	"mtp",
	"usb_mass_storage",
	"adb",
};

/* VIA Telecom defined functions */
static char __maybe_unused *usb_functions_viatelecom_cdrom[] = {
    "usb_mass_storage",
};
static char __maybe_unused *usb_functions_viatelecom_kunlun[] = {
    "usb_mass_storage",
    "rawbulk-modem",
    "rawbulk-at",
};
static char __maybe_unused *usb_functions_viatelecom_kunlun_adb[] = {
    "usb_mass_storage",
    "rawbulk-modem",
    "rawbulk-at",
    "adb",
};
static char __maybe_unused *usb_functions_viatelecom_cbp[] = {
    "rawbulk-modem",
    "rawbulk-ets",
    "rawbulk-at",
    /* Dont mask those codes, even the endpoints of rawbulk are not enough to
     * assign more functions. Leave those will not effect the endpoint
     * assignment */
    "rawbulk-pcv",
    "rawbulk-gps",
};
...
static char *usb_functions_all[] = {
    ...
    /* To avoid the lack of musb endpoint resources, we had to limit the
     * rawbulk use */
    "rawbulk-pcv",
    "rawbulk-gps",
#endif
...
#ifndef CONFIG_USB_ANDROID_KUNLUN_FEATURES
	{
...
#else /* CONFIG_USB_ANDROID_KUNLUN_FEATURES */
	{
        /* CDROM or UMS in Charge-only */
		.product_id     = VIATELECOM_KUNLUN_CDROM_PRODUCT_ID,
		.num_functions  = ARRAY_SIZE(usb_functions_viatelecom_cdrom),
		.functions      = usb_functions_viatelecom_cdrom,
	},
    {
        /* Normal USB Device */
		.product_id     = VIATELECOM_KUNLUN_PRODUCT_ID,
		.adb_product_id = VIATELECOM_KUNLUN_ADB_PRODUCT_ID,
		.num_functions  = ARRAY_SIZE(usb_functions_viatelecom_kunlun_adb),
		.functions      = usb_functions_viatelecom_kunlun_adb,
    },
    {
        /* CBP USB Ports Enumerator */
		.product_id     = VIATELECOM_CBP_PRODUCT_ID,
		.num_functions  = ARRAY_SIZE(usb_functions_viatelecom_cbp),
		.functions      = usb_functions_viatelecom_cbp,
    },
    {
        /* USB Tethering */
        .product_id     = VIATELECOM_KUNLUN_TENTHERING_PRODUCT_ID,
        .adb_product_id = VIATELECOM_KUNLUN_TENTHERING_ADB_PRODUCT_ID,
        .num_functions  = ARRAY_SIZE(usb_functions_rndis_adb),
        .functions      = usb_functions_rndis_adb,
    },
#endif
...
#ifdef CONFIG_USB_ANDROID_KUNLUN_FEATURES
	.vendor_id		    = VIATELECOM_VENDOR_ID,
	.product_id		    = VIATELECOM_KUNLUN_CDROM_PRODUCT_ID,
	.manufacturer_name	= "VIA Telecom Inc.",
	.product_name		= "Kunlun Plus",
...
#ifdef CONFIG_USB_ANDROID_KUNLUN_FEATURES
    .vendorID   = VIATELECOM_VENDOR_ID,
    .vendorDescr    = "VIA Telecom(Hangzhou) Inc.",
#else
...
#ifdef CONFIG_USB_ANDROID_RAWBULK
static struct usb_rawbulk_platform_data rawbulk_pdata = {
    /* Data port */
    .fn_params[RAWBULK_TID_MODEM] = {
        .upstream_transactions = 16,
        .upstream_buffersize = 64,
        .downstream_transactions = 4,
        .downstream_buffersize = 1024,
        .downstream_splitcount = 64,
    },
    /* ETS port */
    .fn_params[RAWBULK_TID_ETS] = {
        .upstream_transactions = 16,
        .upstream_buffersize = 64,
        .downstream_transactions = 4,
        .downstream_buffersize = 1024,
...
static struct platform_device rawbulk_device = {
	.name		= "usb_rawbulk",
	.id		= -1,
	.dev		= {
		.platform_data = &rawbulk_pdata,
	},
};
...
#ifdef CONFIG_USB_ANDROID_RAWBULK
	platform_device_register(&rawbulk_device);
#endif
