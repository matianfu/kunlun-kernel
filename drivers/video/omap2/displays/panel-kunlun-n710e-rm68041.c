...
static int init_lcd_panel(struct spi_device *spi)
{
	...
	spi_send_data(spi, 0x10);//RGB=10  MPU=00

	spi_send_cmd(spi, 0xD0);//Power_Setting (D0h)
	spi_send_data(spi, 0x07);
	spi_send_data(spi, 0x42);
	spi_send_data(spi, 0x1C);

	spi_send_cmd(spi, 0xD1);//VCOM Control (D1h)
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x30);//37 110427
	spi_send_data(spi, 0x1C);//1E 110427

	spi_send_cmd(spi, 0xD2);//Power_Setting for Normal Mode
	spi_send_data(spi, 0x01);
	spi_send_data(spi, 0x11);

	spi_send_cmd(spi, 0xC0);//Panel Driving Setting (C0h)
	spi_send_data(spi, 0x00);//10
	spi_send_data(spi, 0x3B);
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x12);
	spi_send_data(spi, 0x01);

	spi_send_cmd(spi, 0xC1);
	spi_send_data(spi, 0x10);
	spi_send_data(spi, 0x16);
	spi_send_data(spi, 0x88);
	spi_send_cmd(spi, 0xC5);
	spi_send_data(spi, 0x02);
	/***/
	spi_send_cmd(spi, 0xB3);//Frame Memory Access and Interface Setting (B3h)
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x20);
	/******/
	spi_send_cmd(spi, 0xC5);//Frame Rate and Inversion Control (C5h)
	spi_send_data(spi, 0x03);//frame=75hz


	//spi_send_cmd(spi, 0xC6);//RGB SIGNAL SETTTING
	//spi_send_data(spi, 0x00);

	spi_send_cmd(spi, 0xC8);
	spi_send_data(spi, 0x02);
	spi_send_data(spi, 0x75);
	spi_send_data(spi, 0x77);
	spi_send_data(spi, 0x05);
	spi_send_data(spi, 0x0C);
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x03);
	spi_send_data(spi, 0x20);
	spi_send_data(spi, 0x57);
	spi_send_data(spi, 0x53);
	spi_send_data(spi, 0x00);
	spi_send_data(spi, 0x0C);

	spi_send_cmd(spi, 0xF3);
	spi_send_data(spi, 0x40);
