...
#define TAOS_INT_GPIO	113  //wj add
#define ALS_PS_INT       OMAP_GPIO_IRQ(TAOS_INT_GPIO)
...
struct taos_cfg {
        ...
        u8      filter_count;
        u8      gain;
    u16	als_threshold_hi; //add by wj
	u16 als_threshold_lo;	//add by wj
...
struct tmd27713t_platform_data {
